...
function mouseMove(e) {
  ...
  ctx.stroke();
  ctx.strokeStyle = "salmon"; // Pour la couleur de la ligne
  ctx.lineWidth = 5; // Pour la taille de la ligne
}
...
canvas.addEventListener("mousedown", (e) => {
  ...
  // Evenement quand on relache l'appui sur la souris
  canvas.addEventListener("mouseup", () => {
    canvas.removeEventListener("mousemove", mouseMove);
  });
});

// Tout effacé quand on click sur reset 
